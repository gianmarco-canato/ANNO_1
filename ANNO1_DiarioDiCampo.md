...
L'impressione è che dal punto di vista puramente storico l'attenzione per la parte di teatro musicale improvvisato decada nel momento in cui l'apice dell'interesse per l'improvvisazione comincia a scendere, o meglio - finché concerne Nuova Consonanza è di rilievo per l'improvvisazione, e poi le fonti ulteriori sui lavori di Guaccero decadono (tant'è che pare che di Intermedia rimanga ben poco) se non per il loro aspetto di tentativo di raggiungere una forma di teatro totale (Visione della musica come arte partitetica alle altre nella rappresentazione -> base fondante sulla quale viene scritto il manifesto di Intermedia); l'uso dell'improvvisazione all'interno è poco analizzato.
...
#### Strumenti di Movimento per cantanti

#### Workshop marzo improvvisazione solo elettroacustica
